	...
	const handleSubmit = async (e?: React.FormEvent) => {
		...
		try {
			...
			const inwardData = {
				...
				inward_date: detailsFormData.inwardDate || new Date().toISOString().split('T')[0],
				...
				other_reason: detailsFormData.linkToType === 'other' ? (detailsFormData.linkToValue || 'Not specified') : null,
