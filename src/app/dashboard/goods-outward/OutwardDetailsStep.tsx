		...
		<div className="flex flex-col gap-5 py-4">
			...
			<div className="flex flex-col gap-2 text-nowrap px-4">
				...
				<RadioGroup
					...
					onValueChange={(value) => onChange({
						linkToType: value as 'sales_order' | 'job_work' | 'purchase_return' | 'other',
				...
				>
					...
					<RadioGroupItem value="purchase_return">Purchase return</RadioGroupItem>
			...
			<div className="flex flex-col gap-2 px-4">
				<div className="grid grid-cols-2 gap-3">
					...
					<DatePicker
						...
						value={formData.outwardDate ? new Date(formData.outwardDate) : undefined}
			...
			>
				<CollapsibleTrigger className={`flex items-center justify-between w-full py-3 ${showAdditionalDetails ? 'pb-3' : 'pb-0'}`}>
